...
bool rtcrobot_msg__msg__mission__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtcrobot_msg.msg._mission.Mission", full_classname_dest, 33) == 0);
  }
  rtcrobot_msg__msg__Mission * ros_message = _ros_message;
  {  // ip
  ...
  {  // action
    ...
    ros_message->action = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // mission
...
PyObject * rtcrobot_msg__msg__mission__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtcrobot_msg.msg._mission");
