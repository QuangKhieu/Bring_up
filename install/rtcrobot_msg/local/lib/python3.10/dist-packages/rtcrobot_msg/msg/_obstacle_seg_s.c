...
bool rtcrobot_msg__msg__obstacle_seg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtcrobot_msg.msg._obstacle_seg.ObstacleSeg", full_classname_dest, 42) == 0);
  }
  rtcrobot_msg__msg__ObstacleSeg * ros_message = _ros_message;
  {  // first_point
...
{
  /* NOTE(esteve): Call constructor of ObstacleSeg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtcrobot_msg.msg._obstacle_seg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObstacleSeg");
