...
bool rtcrobot_msg__msg__target_node__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtcrobot_msg.msg._target_node.TargetNode", full_classname_dest, 40) == 0);
  }
  rtcrobot_msg__msg__TargetNode * ros_message = _ros_message;
  {  // ip
...
{
  /* NOTE(esteve): Call constructor of TargetNode */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtcrobot_msg.msg._target_node");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TargetNode");
