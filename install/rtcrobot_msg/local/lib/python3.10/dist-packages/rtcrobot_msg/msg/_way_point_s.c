...
bool rtcrobot_msg__msg__way_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtcrobot_msg.msg._way_point.WayPoint", full_classname_dest, 36) == 0);
  }
  rtcrobot_msg__msg__WayPoint * ros_message = _ros_message;
  {  // waypoints
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int8_t * dest = ros_message->waypoints.data;
...
PyObject * rtcrobot_msg__msg__way_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtcrobot_msg.msg._way_point");
  ...
  {  // waypoints
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "waypoints");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->waypoints.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int8_t * src = &(ros_message->waypoints.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->waypoints.size * sizeof(int8_t));
      assert(data != NULL);
