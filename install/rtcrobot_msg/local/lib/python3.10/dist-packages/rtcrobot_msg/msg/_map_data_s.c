...
bool rtcrobot_msg__msg__map_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtcrobot_msg.msg._map_data.MapData", full_classname_dest, 34) == 0);
  }
  rtcrobot_msg__msg__MapData * ros_message = _ros_message;
  {  // name
...
PyObject * rtcrobot_msg__msg__map_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtcrobot_msg.msg._map_data");
