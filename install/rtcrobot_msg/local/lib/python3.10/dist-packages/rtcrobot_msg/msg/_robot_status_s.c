...
bool rtcrobot_msg__msg__robot_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtcrobot_msg.msg._robot_status.RobotStatus", full_classname_dest, 42) == 0);
  }
  rtcrobot_msg__msg__RobotStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // error
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->error.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'error'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject * rtcrobot_msg__msg__robot_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtcrobot_msg.msg._robot_status");
  ...
  {  // error
    ...
    if (ros_message->error.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->error.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->error.size * sizeof(uint8_t));
      assert(data != NULL);
