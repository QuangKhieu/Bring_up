...
{
  new (message_memory) rtcrobot_msg::msg::MapData(_init);
}

void MapData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rtcrobot_msg::msg::MapData *>(message_memory);
  typed_message->~MapData();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember MapData_message_member_array[2] = {
  {
    "name",  // name
    ...
    offsetof(rtcrobot_msg::msg::MapData, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtcrobot_msg::msg::MapData, image),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MapData_message_members = {
  ...
  2,  // number of fields
  sizeof(rtcrobot_msg::msg::MapData),
...
{
  return &::rtcrobot_msg::msg::rosidl_typesupport_introspection_cpp::MapData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtcrobot_msg, msg, MapData)() {
  return &::rtcrobot_msg::msg::rosidl_typesupport_introspection_cpp::MapData_message_type_support_handle;
}
