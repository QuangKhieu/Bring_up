...
rtcrobot_msg__msg__StringStamped__init(rtcrobot_msg__msg__StringStamped * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->data)) {
    rtcrobot_msg__msg__StringStamped__fini(msg);
    return false;
  }
  return true;
}
...
rtcrobot_msg__msg__StringStamped__create()
{
  ...
  rtcrobot_msg__msg__StringStamped * msg = (rtcrobot_msg__msg__StringStamped *)allocator.allocate(sizeof(rtcrobot_msg__msg__StringStamped), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rtcrobot_msg__msg__StringStamped));
  bool success = rtcrobot_msg__msg__StringStamped__init(msg);
  if (!success) {
...
rtcrobot_msg__msg__StringStamped__Sequence__init(rtcrobot_msg__msg__StringStamped__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rtcrobot_msg__msg__StringStamped * data = NULL;

  if (size) {
    data = (rtcrobot_msg__msg__StringStamped *)allocator.zero_allocate(size, sizeof(rtcrobot_msg__msg__StringStamped), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rtcrobot_msg__msg__StringStamped__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rtcrobot_msg__msg__StringStamped__fini(&data[i - 1]);
      }
...
rtcrobot_msg__msg__StringStamped__Sequence__fini(rtcrobot_msg__msg__StringStamped__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rtcrobot_msg__msg__StringStamped__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rtcrobot_msg__msg__StringStamped__Sequence * array = (rtcrobot_msg__msg__StringStamped__Sequence *)allocator.allocate(sizeof(rtcrobot_msg__msg__StringStamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rtcrobot_msg__msg__StringStamped__Sequence__init(array, size);
  if (!success) {
...
rtcrobot_msg__msg__StringStamped__Sequence__destroy(rtcrobot_msg__msg__StringStamped__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rtcrobot_msg__msg__StringStamped__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rtcrobot_msg__msg__StringStamped__Sequence__are_equal(const rtcrobot_msg__msg__StringStamped__Sequence * lhs, const rtcrobot_msg__msg__StringStamped__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rtcrobot_msg__msg__StringStamped__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rtcrobot_msg__msg__StringStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rtcrobot_msg__msg__StringStamped);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rtcrobot_msg__msg__StringStamped * data =
      (rtcrobot_msg__msg__StringStamped *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rtcrobot_msg__msg__StringStamped__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rtcrobot_msg__msg__StringStamped__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rtcrobot_msg__msg__StringStamped__copy(
