...
bool rtcrobot_msg__msg__state_amr__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtcrobot_msg.msg._state_amr.StateAMR", full_classname_dest, 36) == 0);
  }
  rtcrobot_msg__msg__StateAMR * ros_message = _ros_message;
  {  // ip
...
{
  /* NOTE(esteve): Call constructor of StateAMR */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtcrobot_msg.msg._state_amr");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StateAMR");
