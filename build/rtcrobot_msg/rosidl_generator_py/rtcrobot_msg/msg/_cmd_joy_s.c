...
bool rtcrobot_msg__msg__cmd_joy__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtcrobot_msg.msg._cmd_joy.CmdJoy", full_classname_dest, 32) == 0);
  }
  rtcrobot_msg__msg__CmdJoy * ros_message = _ros_message;
  {  // manual
    ...
    ros_message->manual = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // vx
...
{
  /* NOTE(esteve): Call constructor of CmdJoy */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtcrobot_msg.msg._cmd_joy");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CmdJoy");
  ...
  {  // manual
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->manual);
    {
