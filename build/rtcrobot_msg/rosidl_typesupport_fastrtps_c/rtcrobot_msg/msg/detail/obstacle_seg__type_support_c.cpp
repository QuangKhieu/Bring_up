...
#include "rtcrobot_msg/msg/detail/obstacle_seg__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // first_point, last_point
...
using _ObstacleSeg__ros_msg_type = rtcrobot_msg__msg__ObstacleSeg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ObstacleSeg__ros_msg_type * ros_message = static_cast<const _ObstacleSeg__ros_msg_type *>(untyped_ros_message);
  // Field name: first_point
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->first_point, cdr))
    {
      return false;
    }
  }

  // Field name: last_point
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  void * untyped_ros_message)
{
  ...
  _ObstacleSeg__ros_msg_type * ros_message = static_cast<_ObstacleSeg__ros_msg_type *>(untyped_ros_message);
  // Field name: first_point
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _ObstacleSeg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtcrobot_msg__msg__ObstacleSeg(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtcrobot_msg__msg__ObstacleSeg;
    is_plain =
      (
...
static size_t _ObstacleSeg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rtcrobot_msg__msg__ObstacleSeg(
...
static message_type_support_callbacks_t __callbacks_ObstacleSeg = {
  "rtcrobot_msg::msg",
  "ObstacleSeg",
