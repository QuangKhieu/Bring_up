...
#include "rtcrobot_msg/msg/detail/map_data__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // image, name
#include "rosidl_runtime_c/string_functions.h"  // image, name

// forward declare type support functions


using _MapData__ros_msg_type = rtcrobot_msg__msg__MapData;
...
static uint32_t _MapData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtcrobot_msg__msg__MapData(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtcrobot_msg__msg__MapData;
    is_plain =
      (
...
static size_t _MapData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rtcrobot_msg__msg__MapData(
