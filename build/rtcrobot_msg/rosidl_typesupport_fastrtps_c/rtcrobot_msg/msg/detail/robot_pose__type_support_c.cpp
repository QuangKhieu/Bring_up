...
#include "rtcrobot_msg/msg/detail/robot_pose__rosidl_typesupport_fastrtps_c.h"
...
using _RobotPose__ros_msg_type = rtcrobot_msg__msg__RobotPose;
...
static uint32_t _RobotPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtcrobot_msg__msg__RobotPose(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtcrobot_msg__msg__RobotPose;
    is_plain =
      (
...
static size_t _RobotPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rtcrobot_msg__msg__RobotPose(
