...
#include "rtcrobot_msg/msg/detail/state_amr__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // ip, mode, pose
#include "rosidl_runtime_c/string_functions.h"  // ip, mode, pose

// forward declare type support functions


using _StateAMR__ros_msg_type = rtcrobot_msg__msg__StateAMR;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _StateAMR__ros_msg_type * ros_message = static_cast<const _StateAMR__ros_msg_type *>(untyped_ros_message);
  // Field name: ip
  {
  ...
  void * untyped_ros_message)
{
  ...
  _StateAMR__ros_msg_type * ros_message = static_cast<_StateAMR__ros_msg_type *>(untyped_ros_message);
  // Field name: ip
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _StateAMR__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtcrobot_msg__msg__StateAMR(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtcrobot_msg__msg__StateAMR;
    is_plain =
      (
...
static size_t _StateAMR__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rtcrobot_msg__msg__StateAMR(
...
static message_type_support_callbacks_t __callbacks_StateAMR = {
  "rtcrobot_msg::msg",
  "StateAMR",
