...
#include "rtcrobot_msg/msg/detail/amr_conn__rosidl_typesupport_fastrtps_c.h"
...
using _AmrConn__ros_msg_type = rtcrobot_msg__msg__AmrConn;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AmrConn__ros_msg_type * ros_message = static_cast<const _AmrConn__ros_msg_type *>(untyped_ros_message);
  // Field name: ip
  {
  ...
  void * untyped_ros_message)
{
  ...
  _AmrConn__ros_msg_type * ros_message = static_cast<_AmrConn__ros_msg_type *>(untyped_ros_message);
  // Field name: ip
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _AmrConn__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtcrobot_msg__msg__AmrConn(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtcrobot_msg__msg__AmrConn;
    is_plain =
      (
...
static size_t _AmrConn__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rtcrobot_msg__msg__AmrConn(
...
static message_type_support_callbacks_t __callbacks_AmrConn = {
  "rtcrobot_msg::msg",
  "AmrConn",
...
static rosidl_message_type_support_t _AmrConn__type_support = {
