...
#include "rtcrobot_msg/msg/detail/robot_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtcrobot_msg::msg::RobotPose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtcrobot_msg::msg::RobotPose & ros_message)
{
  // Member: ip
  cdr >> ros_message.ip;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtcrobot_msg::msg::RobotPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rtcrobot_msg::msg::RobotPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtcrobot_msg::msg::RobotPose *>(
    untyped_ros_message);
...
{
  return &rtcrobot_msg::msg::typesupport_fastrtps_cpp::_RobotPose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtcrobot_msg, msg, RobotPose)() {
  return &rtcrobot_msg::msg::typesupport_fastrtps_cpp::_RobotPose__handle;
}
