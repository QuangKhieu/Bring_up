...
#include "rtcrobot_msg/msg/detail/mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtcrobot_msg::msg::Mode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtcrobot_msg::msg::Mode & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtcrobot_msg::msg::Mode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rtcrobot_msg::msg::Mode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtcrobot_msg::msg::Mode *>(
    untyped_ros_message);
...
{
  return &rtcrobot_msg::msg::typesupport_fastrtps_cpp::_Mode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtcrobot_msg, msg, Mode)() {
  return &rtcrobot_msg::msg::typesupport_fastrtps_cpp::_Mode__handle;
}
