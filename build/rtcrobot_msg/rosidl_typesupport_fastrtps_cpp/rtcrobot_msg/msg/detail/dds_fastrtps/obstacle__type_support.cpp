...
#include "rtcrobot_msg/msg/detail/obstacle__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtcrobot_msg::msg::Obstacle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rtcrobot_msg::msg::Obstacle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtcrobot_msg::msg::Obstacle *>(
    untyped_ros_message);
...
{
  return &rtcrobot_msg::msg::typesupport_fastrtps_cpp::_Obstacle__handle;
}
