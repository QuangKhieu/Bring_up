...
#include "rtcrobot_msg/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtcrobot_msg::msg::RobotStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtcrobot_msg::msg::RobotStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtcrobot_msg::msg::RobotStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rtcrobot_msg::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtcrobot_msg::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  return &rtcrobot_msg::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtcrobot_msg, msg, RobotStatus)() {
  return &rtcrobot_msg::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
